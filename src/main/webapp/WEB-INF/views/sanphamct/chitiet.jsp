...
<div>
    ...
    ID: ${sanphamCT.id} <br>
    Mã SPCT: ${sanphamCT.maSPCT} <br>
    ID kích thước: ${sanphamCT.idKT} <br>
    ID màu sắc: ${sanphamCT.idMS} <br>
    ID sản phẩm: ${sanphamCT.idSP} <br>
    Số lượng: ${sanphamCT.soLuong} <br>
    Đơn giá: ${sanphamCT.donGia} <br>
    Trạng thái: ${sanphamCT.trangThai ? "Còn hàng" : "Hết hàng"}
</div>
</body>
</html>