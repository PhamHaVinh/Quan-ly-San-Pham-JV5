...
<div>
    ...
    ID: <th>${nhanVien.id}<br>
    Tên: <th>${nhanVien.ten}<br>
    Mã NV: <th>${nhanVien.maNV}<br>
    Tên DN: <th>${nhanVien.tenDN}<br>
    MK: <th>${nhanVien.MK}<br>
    Trạng thái: <th>${nhanVien.trangThai  ? "Nam" : "Nu"}
</div>
</body>
</html>